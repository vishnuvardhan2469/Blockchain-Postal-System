...
function App() {
    ...
    return (
        <>
            ...
            <div className="flex flex-col md:flex-row gap-8 items-center justify-center w-full max-w-6xl px-4 z-10 min-h-[calc(100vh-100px)]">
                ...
                >
                    ...
                    <h2 className="text-4xl font-black mb-4 italic tracking-tighter">USER PORTAL</h2>
                ...
                >
                    ...
                    <h2 className="text-4xl font-black mb-4 italic tracking-tighter">CONTROLLER</h2>
                    <p className="text-slate-500 mb-8 max-w-xs text-lg">
